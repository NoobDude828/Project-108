...
(function(){
  ...
  const COUNTRIES = [
    ...
    ['Belarus','BY','+375'],['Belgium','BE','+32'],['Bhutan','BT','+975'],
    ...
    ['Lebanon','LB','+961'],['Libya','LY','+218'],['Lithuania','LT','+370'],
    ...
    ['New Zealand','NZ','+64'],['Nicaragua','NI','+505'],['Nigeria','NG','+234'],
    ['North Macedonia','MK','+389'],['Norway','NO','+47'],['Oman','OM','+968'],
    ['Pakistan','PK','+92'],['Panama','PA','+507'],['Paraguay','PY','+595'],
    ...
    ['Senegal','SN','+221'],['Serbia','RS','+381'],['Singapore','SG','+65'],
    ['Slovakia','SK','+421'],['Slovenia','SI','+386'],['South Africa','ZA','+27'],
    ['South Korea','KR','+82'],['Spain','ES','+34'],['Sri Lanka','LK','+94'],
    ['Sweden','SE','+46'],['Switzerland','CH','+41'],['Taiwan','TW','+886'],
  ...
  function populateCountries(){
    // Country code: dial code label, value=dial code
    const ccOpts = ['<option value="" disabled selected>Select…</option>'];
    // De-duplicate dial codes; keep alphabetic by country
    const seen = new Set();
    ...
    // Country residence: full name, value=ISO
  ...
  function openModal(role){
    ...
    if(role === 'patron'){
      ...
      ledeEl.textContent = 'Leave your details — a member of our team will be in touch to begin the conversation.';
    } else if(role === 'volunteer'){
      titleEl.innerHTML = 'Register to <em>volunteer</em>.';
      ledeEl.textContent = 'Leave your details — we will share next steps for the build day on 1 November 2026.';
    } else {
      titleEl.innerHTML = 'Take <em>part</em>.';
      ledeEl.textContent = 'Leave your details and we will be in touch with the next steps.';
    }
    form.hidden = false;
